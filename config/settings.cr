...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Test web application."
  #
  #
  ...
  #
  # settings.secret_key_base= CgadeaS5PwURALsw2s_y2FQ-AGXcfFsFTLNd5q1_iHQ
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("chess.log", "w"))
  #
  #
end
